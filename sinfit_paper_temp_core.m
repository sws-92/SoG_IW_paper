...
for i=1:length(rel_station_names)
    ...
    tmp_temp=nanmean(all_ctd.temp(90:110,stn_idx));
    tmp_temp(nan_msk)=[];
...
save('/ocean/sstevens/IW_project/data/represent_stns_t_core.mat','PR2','GO4','S22');
save('/ocean/sstevens/IW_project/data/sinfit_temp_data_core.mat');
...
save('/ocean/sstevens/IW_project/data/sinfit_temp_data_plotting_core.mat');
...
% EBC advection scale
EBCtime=cold_day(114)-cold_day(32); %days
...
%%
set(gcf, 'Color', 'w');
export_fig /ocean/sstevens/IW_project/figures/paper/temp_colday_amp_core.png -png -m3
...
export_fig /ocean/sstevens/IW_project/figures/paper/temp_fits_core.png -png -m3
