...
text(1.025,0.05,'b)','units','normalized','fontsize',8,'Fontweight','bold');
...
title(l,'Node');
text(0.9,0.1,'a)','units','normalized','fontsize',8,'Fontweight','bold');
...
%%
export_fig /ocean/sstevens/IW_project/figures/paper/vec/eulerian.pdf -dpdf
%%
ax5=axes('Position',[0.64 0.19 0.4 .8]);
lat_lim=[50.42283746 48.252093478];
lon_lim=[-125.82436392 -122.252345235];
m_proj('oblique','lon',lon_lim,'lat',lat_lim,'dir','vert','aspect',0.35)
hold on
...
colormap(ax5,cm);
[ax,h]=m_contfbar(ax5,[0.2 0.8],-0.095,CS,CH,'endpiece','yes','axfrac',.04,...
    'edgecolor','none');
...
m_grid('linestyle','none','linewidth',0.5,'tickdir','out',...
    'xticklabel',[],'yticklabel',[]);
text(0.85,0.05,'e)','units','normalized','fontsize',8,'Fontweight','bold');
