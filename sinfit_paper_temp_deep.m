...
for i=1:length(rel_station_names)
    ...
    nmsk=logical(sum(isnan(all_ctd.temp(120:140,stn_idx)))>3);
    all_ctd.temp(:,nmsk)=NaN;

    tmp_temp=nanmean(all_ctd.temp(120:140,stn_idx));
    tmp_temp(nan_msk)=[];
...
idx=cold_day==1| cold_day>200 | amp>1.5;
...
save('/ocean/sstevens/IW_project/data/represent_stns_t_deep.mat','PR2','GO4','S22');
save('/ocean/sstevens/IW_project/data/sinfit_temp_data_deep.mat');
...
save('/ocean/sstevens/IW_project/data/sinfit_temp_data_plotting_deep.mat');
...
%%
set(gcf, 'Color', 'w');
export_fig /ocean/sstevens/IW_project/figures/paper/temp_colday_amp_deep.png -png -m3
...
export_fig /ocean/sstevens/IW_project/figures/paper/temp_fits_deep.png -png -m3
